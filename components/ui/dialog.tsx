...
function DialogHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex flex-col gap-2 text-center sm:text-left sticky top-0 z-40 bg-background pb-4 -mx-6 px-6 pt-2 border-b border-border/50',
        className
      )}
      {...props}
    />
...
function DialogFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sticky bottom-0 z-40 bg-background pt-4 -mx-6 px-6 pb-2 border-t border-border/50',
        className,
      )}
      {...props}
    />
